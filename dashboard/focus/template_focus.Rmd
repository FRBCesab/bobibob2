...
params <- NULL
params$tax <- "Chromista;Ochrophyta;Phaeophyceae;Laminariales;Laminariaceae;Laminaria;Laminaria_digitata"
...
if(nrow(dat)!=0){
  ...
  my_cols<-RColorBrewer::brewer.pal(length(REALM_list),"Set3")  
